...
@section('breadcumb')
    ...
    <li class="breadcrumb-item active" aria-current="page">Informasi Admin</li>
@endsection
        ...
        <section class="section">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Detail Informasi Admin</h4>
                </div>
                <div class="card-body">
                    <x-alert />
                    ...
                    <form action="{{ route('admin.profile.update') }}" method="post">
                        ...
                        <a href="{{ route('admin.profile.pengaturan') }}" class="btn btn-secondary">Pengaturan Akun</a>
                    </form>
                </div>
            </div>
        </section>
