        ...
        <div class="container-fluid px-4">
            <div class="row">
                <div class="col-12">
                    ...
                    {{-- alert nodismissable Messages for Different Scenarios --}}
                    @if (session('success'))
                        <div class="alert nodismissable alert-success alert-dismissible fade show" role="alert">
                    ...
                    @if (session('info'))
                        <div class="alert nodismissable alert-info alert-dismissible fade show" role="alert">
                    ...
                    @if (session('warning'))
                        <div class="alert nodismissable alert-warning alert-dismissible fade show" role="alert">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-4">
                            <div class="card mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">
                                        <i class="fas fa-directions me-2"></i>Pilihan Tindakan
                                    </h6>
                                </div>
                                <div class="card-body">
                                    ...
                                    @if ($bisaLanjutSesi && $bisaLanjutLogis && isset($infoSesiBerikutnya))
                                        ...
                                        <div class="alert nodismissable alert-info mb-3">
                                            <div class="d-flex align-items-center mb-2">
                                                <i class="fas fa-arrow-right text-white me-2"></i>
                                            ...
                                            @if ($infoSesiBerikutnya['nomor'] == 2)
                                                <button type="button" class="btn btn-info btn-sm btn-block mb-2"
                                                    ...
                                                    data-konten-id="1">
                                                    <i class="fab fa-youtube me-2"></i> Pelajari FRAX Tool (Video)
                                                </button>
                                            @endif
                                    ...
                                    @elseif (!$bisaLanjutLogis)
                                        ...
                                        @if ($sesiSekarang == 1 && !$adaFaktaAntara)
                                            ...
                                            <div class="alert nodismissable alert-success mb-3">
                                                <div class="d-flex align-items-center mb-2">
                                        ...
                                        @else
                                            ...
                                            <div class="alert nodismissable alert-warning mb-3">
                                                <div class="d-flex align-items-center mb-2">
                            ...
                            <div class="card mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-dark">
                                        <i class="fas fa-info-circle me-2"></i>Informasi Sesi
                                    </h6>
                                </div>
                                <div class="card-body">
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body" style="max-height: 570px; overflow-y: auto;">
                                        @foreach ($detailSolusi as $solusi)
                                            <div class="alert nodismissable alert-success alert-sm mb-2">
                                                <div class="d-flex align-items-start">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        ...
                                                        @if (!empty($solusi['peringatan']))
                                                            <div
                                                                class="alert nodismissable alert-warning alert-sm mt-2 mb-0 py-1">
                            ...
                            @elseif (empty($hasilKonsultasi['fakta_antara']) && $sesiSekarang > 1)
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        <div class="alert nodismissable alert-warning alert-sm mb-0">
                                            <div class="d-flex align-items-start">
...
@push('scripts-bottom')
    ...
    <script>
        ...
        // Simpan konsultasi function
        function simpanKonsultasi() {
            Swal.fire({
                title: 'Konfirmasi Simpan',
                text: 'Apakah Anda yakin ingin menyimpan konsultasi ini untuk dilanjutkan nanti?',
                icon: 'question',
                showCancelButton: true,
                confirmButtonColor: '#ffc107', // Warna kuning untuk Simpan
                    ...
                    fetch('{{ route('konsultasi.pending') }}', {
                        ...
                        .then(data => {
                            if (data.success) {
                                Swal.fire(
                                    'Berhasil Disimpan!',
                                    'Konsultasi Anda telah disimpan dan bisa dilanjutkan nanti.',
                                    'success'
                                ).then(() => {
                                ...
                                Swal.fire(
                                    'Gagal!',
                                    'Terjadi kesalahan saat menyimpan konsultasi. Silakan coba lagi.',
                                    'error'
                                );
                            }
                        })
                        .catch(error => {
                            ...
                            Swal.fire(
                                'Gagal!',
                                'Terjadi kesalahan jaringan atau server saat menyimpan konsultasi.',
                                'error'
                            );
                        });
                }
        ...
        function selesaikanKonsultasi() {
            Swal.fire({
                ...
                text: 'Apakah Anda yakin ingin menyelesaikan konsultasi ini? Anda akan diarahkan ke halaman hasil.',
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#28a745', // Warna hijau untuk Selesaikan
                cancelButtonColor: '#6c757d', // Warna abu-abu untuk Batal
                    ...
                    fetch('{{ route('konsultasi.complete') }}', {
                        ...
                        .then(data => {
                            if (data.success) {
                                Swal.fire(
                                    'Konsultasi Selesai!',
                                    'Terima kasih telah menyelesaikan konsultasi. Anda akan diarahkan ke halaman hasil.',
                                    'success'
                                ).then(() => {
                                    window.location.href =
                                        '{{ route('konsultasi.result', $konsultasi->id) }}';
                                });
                            } else {
                                Swal.fire(
                                    'Gagal!',
                                    'Terjadi kesalahan saat menyelesaikan konsultasi. Silakan coba lagi.',
                                    'error'
                                );
                            }
                        })
                        .catch(error => {
                            ...
                            Swal.fire(
                                'Gagal!',
                                'Terjadi kesalahan jaringan atau server saat menyelesaikan konsultasi.',
                                'error'
                            );
                        });
                }
