...
@section('content')
    ...
    <div class="page-content">
        <div class="mb-4">
            ...
            <a href="{{ route('edukasi.index', ['jenis' => 'artikel']) }}"
                class="btn btn-outline-primary {{ $jenis == 'artikel' ? 'active' : '' }}">Artikel</a>
            <a href="{{ route('edukasi.index', ['jenis' => 'video']) }}"
                class="btn btn-outline-primary {{ $jenis == 'video' ? 'active' : '' }}">Video</a>
            <a href="{{ route('edukasi.index', ['jenis' => 'infografis']) }}"
                            ...
                            <div class="artikel-thumbnail pointer" data-bs-toggle="modal" data-bs-target="#edukasiModal"
                                ...
                                @else
                                    <div class="card-body card-img-top">
                                        <i class=" bi-file-text fs-1 text-primary"></i>
                                    </div>
                                @endif
                            </div>
                        @endif
